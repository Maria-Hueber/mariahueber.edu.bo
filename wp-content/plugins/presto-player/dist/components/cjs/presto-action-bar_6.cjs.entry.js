...
const PrestoMutedOverlay = class {
  ...
  render() {
    ...
    return (index.h("div", { class: "presto-player__muted-overlay", onClick: () => {
        ...
        this.playVideo.emit();
      } }, index.h("div", { class: "plyr__control plyr__control--overlaid", "data-plyr": "play", "aria-label": "Play", part: "muted-overlay-play" }, index.h("svg", { id: "plyr-play", viewBox: "0 0 18 18" }, index.h("path", { d: "M15.562 8.1L3.87.225c-.818-.562-1.87 0-1.87.9v15.75c0 .9 1.052 1.462 1.87.9L15.563 9.9c.584-.45.584-1.35 0-1.8z" })), index.h("span", { class: "plyr__sr-only" }, "Play")), ((_a = this.mutedOverlay) === null || _a === void 0 ? void 0 : _a.enabled) && ((_b = this.mutedOverlay) === null || _b === void 0 ? void 0 : _b.src) ? (index.h("div", { class: "presto-player__overlay is-image", part: "muted-overlay-image", style: {
      ...
      } }, index.h("img", { src: (_h = this.mutedOverlay) === null || _h === void 0 ? void 0 : _h.src, style: { transform: 'translateX(-50%) translateY(-50%)' } }))) : ('')));
  }
};
...
const PrestoVimeo = class {
  ...
  render() {
    ...
    return (index.h("div", { class: "plyr__video-embed", part: "embed", ref: this.getRef }, index.h("iframe", { src: `https://player.vimeo.com/video/${this.getId(this.src)}?loop=false&amp;byline=false&amp;portrait=false&amp;title=false&amp;speed=true&amp;transparent=0&amp;gesture=media`, allowFullScreen: true, allowTransparency: true, allow: "autoplay" })));
  }
};
...
const PrestoYoutube = class {
  ...
  render() {
    ...
    if (this.lazyLoad) {
      return (index.h("div", null, index.h("presto-video", { part: "video", getRef: this.getRef, poster: this.poster, src: "" }), index.h("div", { class: "presto-player__play-cover", onClick: () => this.loadPlayer() })));
    }
