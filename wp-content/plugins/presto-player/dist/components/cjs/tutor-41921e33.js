...
function tutor (player) {
  ...
  var autoload_content = function autoload_content() {
    ...
    if (!_tutorobject.nonce_key || !((_tutorobject2 = _tutorobject) === null || _tutorobject2 === void 0 ? void 0 : _tutorobject2.ajaxurl)) {
      return;
    }
    ...
    jQuery.post((_tutorobject3 = _tutorobject) === null || _tutorobject3 === void 0 ? void 0 : _tutorobject3.ajaxurl, data).done(function (response) {
      ...
      if ((response === null || response === void 0 ? void 0 : response.success) && (response === null || response === void 0 ? void 0 : (_response$data = response.data) === null || _response$data === void 0 ? void 0 : _response$data.next_url)) {
