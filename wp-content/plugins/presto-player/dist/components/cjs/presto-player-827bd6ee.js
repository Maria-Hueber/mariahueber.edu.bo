...
const ajaxProgress = (function () {
  ...
  wp.hooks.addAction('presto.playerGetNonce', 'presto-player', function () {
    ...
    fetch("".concat((_window = window) === null || _window === void 0 ? void 0 : (_window$prestoPlayer = _window.prestoPlayer) === null || _window$prestoPlayer === void 0 ? void 0 : _window$prestoPlayer.ajaxurl, "?action=presto_refresh_progress_nonce")).then(status).then(function (response) {
  ...
  function sendTimeUpdate(player) {
    ...
    if (!(player !== null && player !== void 0 && (_player$config = player.config) !== null && _player$config !== void 0 && _player$config.ajaxProgress)) {
      return;
    }
    ...
    Object.keys(watched).forEach(function (marker) {
      ...
      if (!player.watched[marker] && percent >= parseInt(marker)) {
        var _player$config2, _window2, _window2$prestoPlayer, _window3, _window3$prestoPlayer;
        ...
        if ((_window2 = window) !== null && _window2 !== void 0 && (_window2$prestoPlayer = _window2.prestoPlayer) !== null && _window2$prestoPlayer !== void 0 && _window2$prestoPlayer.debug) {
          console.log("".concat(marker, " percent watched."));
        }

        if (!((_window3 = window) !== null && _window3 !== void 0 && (_window3$prestoPlayer = _window3.prestoPlayer) !== null && _window3$prestoPlayer !== void 0 && _window3$prestoPlayer.debug_navigator)) {
          var _window4, _window4$prestoPlayer, _window5, _window5$prestoPlayer;

          var result = navigator.sendBeacon((_window4 = window) === null || _window4 === void 0 ? void 0 : (_window4$prestoPlayer = _window4.prestoPlayer) === null || _window4$prestoPlayer === void 0 ? void 0 : _window4$prestoPlayer.ajaxurl, formData);

          if ((_window5 = window) !== null && _window5 !== void 0 && (_window5$prestoPlayer = _window5.prestoPlayer) !== null && _window5$prestoPlayer !== void 0 && _window5$prestoPlayer.debug) {
            if (result) {
              var _player$config3;
          ...
          var _window6, _window6$prestoPlayer, _player$config5;

          jQuery.ajax({
            type: 'POST',
            url: (_window6 = window) === null || _window6 === void 0 ? void 0 : (_window6$prestoPlayer = _window6.prestoPlayer) === null || _window6$prestoPlayer === void 0 ? void 0 : _window6$prestoPlayer.ajaxurl,
            dataType: 'json',
            cache: false,
            data: {
...
function PrestoPlayer$1 (element) {
  ...
  if (typeof learndash_video_data !== 'undefined') {
    Promise.resolve().then(function () { return require('./learndash-53f559ee.js'); }).then(function (module) {
...
const createPlayer = (function (_ref) {
  ...
  if (src && isHLS(src)) {
    return Promise.resolve().then(function () { return require('./hls-a88d401c.js'); }).then(function (module) {
...
const PrestoPlayer = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { style: { height: this.isSticky ? `${this.videoHeight}px` : 'auto' } }, index.h("div", { part: "wrapper", dir: this.direction, class: `presto-player__wrapper fitvidsignore
        ...
        ${this.playClass ? this.playClass : ''}` }, index.h("div", null, index.h("slot", { name: "player-start" }), this.renderEmailOverlay(), index.h("slot", { name: "player-before-video" }), this.renderVideo(), index.h("slot", { name: "player-after-video" }), this.renderActionBar(), this.renderMutedOverlay(), index.h("slot", { name: "player-end" })))));
  }
