...
function PrestoPlayer$1 (element) {
  ...
  if (typeof learndash_video_data !== 'undefined') {
    import('./learndash-f7dde3be.js').then(function (module) {
...
const createPlayer = (function (_ref) {
  ...
  if (src && isHLS(src)) {
    return import('./hls-dcb58c59.js').then(function (module) {
...
const PrestoPlayer = class {
  ...
  render() {
    ...
    return (h(Host, { style: { height: this.isSticky ? `${this.videoHeight}px` : 'auto' } }, h("div", { part: "wrapper", dir: this.direction, class: `presto-player__wrapper fitvidsignore
        ...
        ${this.playClass ? this.playClass : ''}` }, h("div", null, h("slot", { name: "player-start" }), this.renderEmailOverlay(), h("slot", { name: "player-before-video" }), this.renderVideo(), h("slot", { name: "player-after-video" }), this.renderActionBar(), this.renderMutedOverlay(), h("slot", { name: "player-end" })))));
  }
